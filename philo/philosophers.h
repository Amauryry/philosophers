...
int							skip_time(int time, t_data *data,
								t_philosopher *philo);
...
void						print_message(const char *s, t_data *data,
								t_philosopher *philo);
int							handle_meal_check(t_data *data,
								t_philosopher *philo);
int							handle_meal_state(t_data *data,
								t_philosopher *philo, int temp);
